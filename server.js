...
// ----------------------------------------------------
const pendingRegistrations = {}; // <--- لإكمال التسجيل بعد التحقق من الإيميل 
...
app.post("/api/auth/signup", async (req, res) => {
  try {
    // ----------------------------------------------------
    // *** التعديل الرئيسي: استقبال الاسم والتحقق منه ***
    // ----------------------------------------------------
    ...
    const mailOptions = {
      from: SENDER_EMAIL, // <--- إرسال من إيميل الدومين الجديد
      to: email,
