...
io.on('connection', (socket) => {
    // ... (هاد الكود كيبقى كيفما هو، مافيه حتى تغيير) ...
...
app.post("/api/auth/login", async (req, res) => { /* ... (كلشي كيبقى كيفما هو هنا) ... */ });

// --- مسارات تفعيل الاشتراك ---
app.post("/api/request-code", authMiddleware, async (req, res) => { /* ... */ });
app.post("/api/activate-with-code", authMiddleware, async (req, res) => { /* ... (كلشي كيبقى كيفما هو هنا) ... */ });

// --- مسارات محمية (Protected Routes) ---
app.get("/api/check-status", authMiddleware, (req, res) => { /* ... */ });
app.post("/api/whatsapp/logout", authMiddleware, async (req, res) => { /* ... (كلشي كيبقى كيفما هو هنا) ... */ });
...
app.get("/contacts", authMiddleware, checkSubscription, (req, res) => { /* ... (Kib9a b7al b7al) ... */ });
app.get("/imported-contacts", authMiddleware, checkSubscription, (req, res) => { /* ... (Kib9a b7al b7al) ... */ });
